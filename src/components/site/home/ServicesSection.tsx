import { ArrowRight, Box, ScanLine, ScanFace, ShieldCheck } from "lucide-react";
...
const serviceVisuals = [
  { image: cbctImage.src, srcSet: `${cbctImageSmall.src} 640w, ${cbctImage.src} 1086w`, alt: "Pacijentkinja tokom 3D CBCT snimanja", Icon: Box },
  { image: assetPath("images/Ortopan.jpg"), srcSet: undefined, alt: "Panoramski 2D snimak zuba", Icon: ScanLine },
  { image: assetPath("images/Lateralni kefalogram.jpg"), srcSet: undefined, alt: "Lateralni kefalometrijski snimak", Icon: ScanFace },
];
